...
//query string that will be used to query the database and find each jobsave that matches the seeker's id
//and status is equal to 1
$query = "SELECT * FROM jobsave WHERE sId = ".$id." AND status = '1'";
